...
public class PhotosArray {
    ...
    public PhotosArray(String id, String owner, String secret, String server, int farm, String title, int ispublic, int isfriend, int isfamily, String url_s, int height_s, int width_s) {
        this.id = id;
        this.owner = owner;
        this.secret = secret;
        this.server = server;
